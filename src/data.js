...
export const programacao = [
  ...
  },
  {
    ...
    resumo: "Nessa palestra daremos uma noção sobre a área de ciência de dados e como utilizar bases de dados para obter padrões e encontrar informações importantes  que podem agregar muito no processo de tomada de decisão.",
    palestrante: getPalestrante("jessica")
  },
  {
    horario: "9:50",
    titulo: "Simplificando o desenvolvimento Android com Koin",
    resumo: "O objetivo da palestra é apresentar a Koin, passo-a-passo, através de um simples projeto utilizando Kotlin + Android, abordando suas principais funcionalidades(escopos, injeção de ViewModels, etc) e demonstrando como pode ser fácil e eficiente utilizar injeção de dependências. Ao final, a própria Koin será comparada à outras opções disponíveis e comuns no mercado, como Dagger e Kodein, utilizando dados como: desempenho, curva de aprendizado, problemas com manutenção, etc.",
    palestrante: getPalestrante("wilson")
  },
  {
    horario: "10:40",
    titulo: "Como Começar com IoT",
    resumo: "Como começar a criar produtos utilizando Iot (Internet das coisas), demostrarei como funcionam os microcontroladores, sensores e como fazer tudo isso comunicar via internet.",
    palestrante: getPalestrante("alex")
  },
  {
    horario: "11:30",
    titulo: "Implementando sua primeira solução de IOT usando Firebase",
    resumo: "A palestra trará conceitos básicos sobre arquitetura de microcontroladores, conceitos básicos sobre sensores analógicos e digitais, configuração de ambiente de desenvolvimento e os passos da implementação.",
  ...
  },
  {
    ...
    resumo: "Uma apresentação introdutória de como configurar um projeto e criar uma arquitetura que seja produtiva e testável, mantendo a estrutura MVVM com RxJava e Architecture Components. Cansado(a) de pesquisar onde, o que e como se encaixa no projeto? Nessa palestra vou testar explicar algumas delas.",
    palestrante: getPalestrante("thiagos")
  },
  {
    horario: "14:50",
    titulo: "Coroutines e Flow",
    resumo: "Entenda como funciona coroutines e o flow, como utilizá-los no desenvolvimento de seus apps",
